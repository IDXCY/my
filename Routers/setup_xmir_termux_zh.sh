...
#!/usr/bin/env bash
cd $HOME/xmir-patcher && python3 menu.py
EOF
chmod +x $HOME/start_xmir.sh

# ================================= 6. 自动启动 =================================
echo -e "\n\033[1;32m=========================================\033[0m"
echo -e "\033[1;32m 🎉 部署成功！正在启动中文控制台...\033[0m"
echo -e "\033[1;33m 💡 提示：后续若需再次启动，请在 Termux 中运行：\033[0m"
echo -e "\033[1;36m    ~/start_xmir.sh\033[0m"
echo -e "\033[1;32m=========================================\033[0m\n"

# 清理下载的安装脚本自身
rm -f "$HOME/setup_xmir_termux_zh.sh" 2>/dev/null || true
